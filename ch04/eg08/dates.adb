...
--
--   File:    dates.adb
--   Purpose: Date-handling package (body) with initialisation section
...
begin       -- package initialisation code
    Ada.Text_IO.Put_Line ("This program uses Dates by John English");
end Dates;
