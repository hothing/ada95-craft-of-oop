...
--
--   File:    je-diaries.adb
--   Purpose: Diary ADT (body) for meetings diary
...
package body JE.Diaries is
    ...
    package Appt_IO is new Ada.Sequential_IO (Meeting_Type);
    ...
    function Choose (Diary : Diary_Type;
                     Appt  : Positive) return Meeting_Type is
